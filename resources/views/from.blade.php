                    ...
                    <div class="card card-default">
                        ...
                        <div class="card-body">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Poroshaba" aria-label="Poroshaba"
                                    aria-describedby="basic-addon1">
                            </div>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Unions" aria-label="Unions"
                                    aria-describedby="basic-addon1">
                            </div>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Word" aria-label="Word"
                                    aria-describedby="basic-addon1">
                            </div>
                    ...
                    <div class="card card-default">
                        ...
                        <div class="card-body">
                            ...
                            <div id="localAddressFields" style="display: none;">
                                ...
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text mdi mdi-map-marker-multiple"
                                            id="basic-addon3"><span class="ml-2">Divisions</span></span>
                                    </div>
                                    <select class="form-control" id="exampleFormControlSelect1">
                                        <option>1</option>
                                        <option>2</option>
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Poroshaba"
                        ...
                        <div class="card-body">
                            ...
                            <div id="education-section">
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text mdi mdi-home-modern" id="basic-addon3"><span
                                                class="ml-2">College/University Name</span></span>
                                    </div>
